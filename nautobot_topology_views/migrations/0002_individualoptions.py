...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('extras', '0084_staging'),
        ('nautobot_topology_views', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preselected_device_roles', models.ManyToManyField(blank=True, db_table='nautobot_topology_views_individualoptions_preselected_device', related_name='+', to='dcim.devicerole')),
                ('preselected_tags', models.ManyToManyField(blank=True, db_table='nautobot_topology_views_individualoptions_preselected_tag', related_name='+', to='extras.tag')),
