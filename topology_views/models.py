"""Models for Nautobot Topology Views."""
...
class RoleImage(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for Nautobot Topology Views app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "Nautobot Topology Viewss"
