...
<<<<<<< HEAD
Draft a [new release](https://github.com/nautobot/nautobot-app-topology-views/releases/new) with the following parameters.
=======
Draft a [new release](https://github.com/jdrew82/nautobot-plugin-topology-views/releases/new) with the following parameters.
>>>>>>> 5c275df (Cookie initially baked targeting develop by NetworkToCode Cookie Drift Manager Tool)
...
<<<<<<< HEAD
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/nautobot/nautobot-app-topology-views/pull/123` -> `* @nautobot_user`.
=======
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/jdrew82/nautobot-plugin-topology-views/pull/123` -> `* @nautobot_user`.
>>>>>>> 5c275df (Cookie initially baked targeting develop by NetworkToCode Cookie Drift Manager Tool)
...
<<<<<<< HEAD
**Full Changelog**: https://github.com/nautobot/nautobot-app-topology-views/compare/v1.4.1...v1.4.2
=======
**Full Changelog**: https://github.com/jdrew82/nautobot-plugin-topology-views/compare/v1.4.1...v1.4.2
>>>>>>> 5c275df (Cookie initially baked targeting develop by NetworkToCode Cookie Drift Manager Tool)
```
